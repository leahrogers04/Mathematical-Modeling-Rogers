...
void setInitailConditions()
{
	...
	massOfCeres = 9.383*pow(10,20); // kg
	...
	printf("\n DiameterOfCeres = %e kilometers", diameterOfCeres);
	printf("\n densityOfCeres = %e kilograms/kilometers^3", densityOfCeres);
	printf("\n volumeOfCeres = %e kilometers^3" ,volumeOfCeres);
	printf("\n MassOfCeres = %e kilograms" ,massOfCeres);
